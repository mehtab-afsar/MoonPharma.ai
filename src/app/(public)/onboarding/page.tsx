  ...
  return (
    <div className="text-center space-y-6 py-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <Button variant="outline" className="w-full" onClick={() => router.push(ROUTES.MBR_NEW)}>
          Create First MBR
        </Button>
        <Button variant="outline" className="w-full" onClick={() => router.push(ROUTES.DASHBOARD)}>
          Go to Dashboard
        </Button>
      </div>
    </div>
